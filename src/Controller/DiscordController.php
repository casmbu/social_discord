...
class DiscordController extends OAuth2ControllerBase {
  ...
  public function __construct(
	...
	parent::__construct('Social Discord', 'social_discord', $messenger, $network_manager, $user_authenticator, $discord_manager, $request, $data_handler);
  }
  ...
  public function callback() {
	...
	if ($discord_profile !== NULL) {
		...
		$data = $this->userAuthenticator->checkProviderIsAssociated($discord_profile->getId()) ? NULL : $this->providerManager->getExtraDetails();
		...
		return $this->userAuthenticator->authenticateUser($discord_profile->getUsername(), $discord_profile->getEmail(), $discord_profile->getId(), $this->providerManager->getAccessToken(), $avatar, $data);
	}
